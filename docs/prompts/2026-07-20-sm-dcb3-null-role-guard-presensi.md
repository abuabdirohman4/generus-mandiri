...
TASK:
Eksekusi implementation plan di @docs/plans/2026-07-20-sm-dcb3-null-role-guard-presensi.md

ISSUE: sm-dcb3 / GH-#150
BRANCH: fix/sm-dcb3-null-role-guard
...
REFERENCE FILES:
- Plan: @docs/plans/2026-07-20-sm-dcb3-null-role-guard-presensi.md
- Rules: @CLAUDE.md
- Architecture: @docs/claude/architecture-patterns.md
- PRASYARAT: sm-iywv harus closed dulu (butuh sourcemap)
- Sentry issue: https://generus-mandiri.sentry.io/issues/GENERUS-MANDIRI-S
