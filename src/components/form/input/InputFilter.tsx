    ...
    <div className={`${className} ${containerClass}`}>
      <div className={wrapperClass}>
        ...
        <select
          ...
          disabled={disabled}
          required={required}
          className={`w-full px-3 py-2 border bg-white rounded-md shadow-sm focus:outline-none focus:ring-2 appearance-none bg-no-repeat bg-right bg-size-[16px] pr-8 disabled:opacity-50 disabled:cursor-not-allowed ${
            error 
