...
import type { MateriColumnVisibility } from '../../stores/materiStore';

interface ColumnToggleProps {
    columns: Array<{ key: keyof MateriColumnVisibility; label: string }>;
    visibility: MateriColumnVisibility;
    onChange: (visibility: Partial<MateriColumnVisibility>) => void;
}

export default function ColumnToggle({ columns, visibility, onChange }: ColumnToggleProps) {
