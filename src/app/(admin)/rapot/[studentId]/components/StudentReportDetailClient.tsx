    ...
    return (
        <div className="space-y-6 pb-20">
                            ...
                            <div key={aspect} className="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-700 last:border-0">
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        placeholder="-"
                                        onChange={(e) => {
                                            // Handle character grade change if numeric, or just text? 
                                            // User screenshot shows numeric 95, 90, 80.
                                            // My schema uses `grade: VARCHAR(5)`. So I can store number as string.
                                    ...
                                    />
                                    {/* Calculated Predicate Label based on grade? */}
            ...
            <PDFExportModal
                ...
                onExport={(options) => {
                    toast.info('Fitur PDF Export akan segera tersedia');
                }}
            />
        </div>
    );
